...
@section('page')
    <div>
        ...
        @else
            <div class="m-auto w-1/2 mt-52 py-4 px-2 text-center border-2 border-red-500 flex flex-col items-center justify-center">
                <p class="mx-auto">
                    Ещё нет фотография или неправильный фильтр
                </p>
                @if ($filters)
                    <a href="{{ route('images.index')}}">Убрать фильтры</a>
                @endif
            </div>
        @endif
    </div>
